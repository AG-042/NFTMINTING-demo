...
NFT Minting Demo with IPFS (Filebase) integration
"""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-nft-minting-demo-change-in-production')
...
FILEBASE_BUCKET_NAME = config('FILEBASE_BUCKET_NAME', default='nft-minting')
